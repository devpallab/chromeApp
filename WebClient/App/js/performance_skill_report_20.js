		...
		this.getHeaderData = function () {
			var aHeaderData 	= [],
				...
				var iWeekFrom = (iUnit === iUnitFrom) ? 1 : iWeekFrom4mSlider,
					...
					aHeaderData[iCnt] = {};
					aHeaderData[iCnt].fIdx = iWeekFrom;//+ '.' + ((iWeekFrom * iLessonsPerWeek) - 4);
...
PerformanceView.renderSkillReportContent = function () {
	...
	// Start: IPP-4602: Extra practice data should not be plotted in Skill tab in perf DB
	aFilterSkillData = _.reject(
		aFilterSkillData,
		function (rec) {
			return rec.ExtraPractice == "Yes"
		}
	);
	//console.log(aFilterSkillData);
	// End: IPP-4602: Extra practice data should not be plotted in Skill tab in perf DB
										...
										if(
											...
											if(
												...
												if (sSubSkillId == 'f1d74032e2b64e5ebf233f07b33e8ea5') {
													...
													//console.log(nSkillObtainedScore);
												...
												// for others
													...
													//console.log(fSkillScore);
													//console.log(fSkillMaxScore);
												}
...
//	console.log(oFinalSkillBasedData);
	...
	$(".showSkillToolTip").off('click tap').on('click tap', function (e) {
		...
		if(oInfoContent != "") {
			...
			var boxOffsetLeft = $(this).offset().left,
				...
				sbrContainerMaxRightPos = $(".skill-content-right").position().left + $(".skill-content-right").width(),
				arrowOffsetLeft = 0;
				//console.log(sbrContainerMaxRightPos);
				//console.log(boxOffsetLeft);
				//console.log(infoBubbleWidth);
			...
			if ((boxOffsetLeft + infoBubbleWidth) > sbrContainerMaxRightPos) {
				...
				var leftWidth = ((sbrContainerMaxRightPos - infoBubbleWidth) < infoBubbleWidth) ? boxOffsetLeft : (sbrContainerMaxRightPos - infoBubbleWidth);
				
				
				
				$("#skillInfoBubble").css({
					'position' : 'absolute',
					'left':  leftWidth/* (sbrContainerMaxRightPos - infoBubbleWidth) */ + 'px',
					'top' : top + "px",
					'opacity': 1
				});
			}
